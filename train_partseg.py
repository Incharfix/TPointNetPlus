...
def parse_args():
    ...
    parser.add_argument('--epoch',  default=501, type=int, help='Epoch to run [default: 251]')
    ...
    parser.add_argument('--npoint', type=int,  default=input_npoint, help='Point Number [default: 2048]')
...
def main(args):
    ...
    for epoch in range(start_epoch,args.epoch):
        ...
        #
        WriteTxtLine(TxtLine_trainacc, str(epoch) + " " + str(train_instance_acc))
        WriteTxtLine(TxtLine_trainloss, str(epoch) + " " + str(loss.item()))
